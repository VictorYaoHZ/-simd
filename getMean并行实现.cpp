...
mean[2].y = point[6].y;
	...
	*/
	...
	//计时结束
	cout << "total time of getE is" << time_getE << endl;
	cout << "total time of getMean is" << time_getMean << endl;
	cout << "total time of cluster is" << time_cluster << endl;
}
void doit1()
{
	int i, j, n = 0;
